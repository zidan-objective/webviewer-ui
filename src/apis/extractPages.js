 ...
 * @param {Array<number>} pageIndexToExtract An array of pages to extract
 * @return {CoreControls.ReaderControl#extractPages} A promise that resolve to a <a href='https://developer.mozilla.org/en-US/docs/Web/API/File' target='_blank'>File object</a>
