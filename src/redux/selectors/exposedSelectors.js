...
export const getWarningMessage = state =>
  (state.viewer.warning && state.viewer.warning.message) || '';
export const getWarningTitle = state =>
  (state.viewer.warning && state.viewer.warning.title) || '';
export const getWarningConfirmEvent = state =>
  state.viewer.warning && state.viewer.warning.onConfirm;
