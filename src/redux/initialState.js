...
export default options => ({
  viewer: {
    ...
    activeToolStyles: {},
    activeLeftPanel: options.hideAnnotationPanel || options.readonly ? 'thumbnailsPanel' : 'notesPanel',
    activeToolGroup: '',
    expandedNotes: {},
    notePopupId: '',
    isNoteEditing: false,
    ...
    isFullScreen: false,
    doesAutoLoad: typeof options.auto_load === 'boolean' ? options.auto_load : true,
  ...
  advanced: {
    ...
    useDownloader: typeof options.useDownloader === 'boolean' ? options.useDownloader : true,
