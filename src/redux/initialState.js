...
export default {
  viewer: {
    ...
    isAccessibleMode: accessibleMode,
    measurementUnits: {
      from: ['in', 'mm', 'cm', 'pt'],
  ...
  advanced: {
    ...
    customCSS: css,
    customHeaders: {},
    defaultDisabledElements: disabledElements,
    externalPath: p,
    engineType: documentTypeParamToEngineType(pdftronServer),
    fullAPI: pdfnet,
    pdftronServer,
    singleServerMode,
    forceClientSideInit,
